...
export const metadata: Metadata = {
  title: "Best WhatsApp Marketing Software - BoostACart",
  description: "Find the ultimate whatsapp cart recovery tool tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
...
const pageData: SeoPageData = {
  ...
  "metaTitle": "Best WhatsApp Marketing Software - BoostACart",
  "metaDescription": "Find the ultimate whatsapp cart recovery tool tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "WhatsApp Marketing",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your whatsapp cart recovery tool efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master whatsapp cart recovery tool, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine whatsapp cart recovery tool by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "WhatsApp Marketing",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for whatsapp cart recovery tool?",
