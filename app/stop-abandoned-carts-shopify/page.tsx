...
export const metadata: Metadata = {
  title: "Best Stopping Abandonment Software - BoostACart",
  description: "Find the ultimate stop abandoned carts shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/stop-abandoned-carts-shopify"
  },
  openGraph: {
    title: "Best Stopping Abandonment Software - BoostACart",
    description: "Find the ultimate stop abandoned carts shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/stop-abandoned-carts-shopify",
    type: "website"
  }
};
...
const pageData: SeoPageData = {
  ...
  "metaTitle": "Best Stopping Abandonment Software - BoostACart",
  "metaDescription": "Find the ultimate stop abandoned carts shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Stopping Abandonment",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your stop abandoned carts shopify efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master stop abandoned carts shopify, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine stop abandoned carts shopify by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Stopping Abandonment",
  ...
  "internalLinks": [
    ...
    },
    {
      ...
      "color": "fuchsia",
      "title": "High Ticket Recovery",
      "subtitle": "Specialized tactics for $500+ AOV."
    }
  ],
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for stop abandoned carts shopify?",
