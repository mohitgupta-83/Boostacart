...
export const metadata: Metadata = {
  title: "Case Study: How PulseFit achieved 37 Recovered Orders in 1 Day with BoostACart",
  description: "Read the in-depth case study on how PulseFit deployed pre-checkout cart recovery to achieve 37 Recovered Orders in 1 Day scaling their D2C brand on Shopify.",
  alternates: {
...
const pageData: SeoPageData = {
  "slug": "case-study-recovered-37-orders",
  "metaTitle": "Case Study: How PulseFit achieved 37 Recovered Orders in 1 Day with BoostACart",
  "metaDescription": "Read the in-depth case study on how PulseFit deployed pre-checkout cart recovery to achieve 37 Recovered Orders in 1 Day scaling their D2C brand on Shopify.",
  "heroBadge": "Verified Case Study",
  "heroTitleLight": "How PulseFit Achieved",
  "heroTitleHighlight": "37 Recovered Orders in 1 Day",
  "heroSubtitle": "An inside look at the exact timing, sequences, and scripts PulseFit used to recover massive amounts of abandoned revenue using BoostACart.",
  "problemBadge": "The Challenge",
  "problemTitle": "PulseFit Was Losing Traffic At",
  "problemHighlight": "The Cart Page",
  "problemText1": "Before using BoostACart, PulseFit was spending thousands on Meta and TikTok ads, driving heavy traffic that would click Add-to-Cart but bounce before typing their email at checkout.",
  ...
  "solutionText": "PulseFit installed our async snippet in exactly 2 minutes. They enabled the WhatsApp fallback mechanism and offered a 10% discount to users who unlocked their cart.",
  ...
  "featuresSubtitle": "Here are the tools in our platform that allowed PulseFit to completely transform their back-end economics.",
  "features": [
    {
      "icon": "cart",
  ...
  "faqs": [
    {
      "question": "Can my store replicate PulseFit's results?",
    ...
    {
      "question": "Did PulseFit need a developer for this?",
