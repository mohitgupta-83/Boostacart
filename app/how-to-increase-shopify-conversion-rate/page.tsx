...
export const metadata: Metadata = {
  title: "The Ultimate Guide to Shopify Conversions - BoostACart",
  description: "Master how to increase shopify conversion rate. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/how-to-increase-shopify-conversion-rate"
  },
  openGraph: {
    title: "The Ultimate Guide to Shopify Conversions - BoostACart",
    description: "Master how to increase shopify conversion rate. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/how-to-increase-shopify-conversion-rate",
    type: "website"
  }
};
...
const pageData: SeoPageData = {
  ...
  "metaTitle": "The Ultimate Guide to Shopify Conversions - BoostACart",
  "metaDescription": "Master how to increase shopify conversion rate. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "Shopify Conversions",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your how to increase shopify conversion rate efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master how to increase shopify conversion rate, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine how to increase shopify conversion rate by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Adding Sales",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve how to increase shopify conversion rate?",
