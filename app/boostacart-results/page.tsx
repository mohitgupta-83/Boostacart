...
export const metadata: Metadata = {
  title: "Case Study: How BoostACart Merchants achieved Industry Leading Results with BoostACart",
  description: "Read the in-depth case study on how BoostACart Merchants deployed pre-checkout cart recovery to achieve Industry Leading Results scaling their D2C brand on Shopify.",
  alternates: {
...
const pageData: SeoPageData = {
  "slug": "boostacart-results",
  "metaTitle": "Case Study: How BoostACart Merchants achieved Industry Leading Results with BoostACart",
  "metaDescription": "Read the in-depth case study on how BoostACart Merchants deployed pre-checkout cart recovery to achieve Industry Leading Results scaling their D2C brand on Shopify.",
  "heroBadge": "Verified Case Study",
  "heroTitleLight": "How BoostACart Merchants Achieved",
  "heroTitleHighlight": "Industry Leading Results",
  "heroSubtitle": "An inside look at the exact timing, sequences, and scripts BoostACart Merchants used to recover massive amounts of abandoned revenue using BoostACart.",
  "problemBadge": "The Challenge",
  "problemTitle": "BoostACart Merchants Was Losing Traffic At",
  "problemHighlight": "The Cart Page",
  "problemText1": "Before using BoostACart, BoostACart Merchants was spending thousands on Meta and TikTok ads, driving heavy traffic that would click Add-to-Cart but bounce before typing their email at checkout.",
  ...
  "solutionText": "BoostACart Merchants installed our async snippet in exactly 2 minutes. They enabled the WhatsApp fallback mechanism and offered a 10% discount to users who unlocked their cart.",
  ...
  "featuresSubtitle": "Here are the tools in our platform that allowed BoostACart Merchants to completely transform their back-end economics.",
  "features": [
    {
      "icon": "cart",
  ...
  "faqs": [
    {
      "question": "Can my store replicate BoostACart Merchants's results?",
    ...
    {
      "question": "Did BoostACart Merchants need a developer for this?",
