...
export const metadata: Metadata = {
  title: "Best SMS Workflows Software - BoostACart",
  description: "Find the ultimate sms cart recovery app tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/sms-cart-recovery-app"
  },
  openGraph: {
    title: "Best SMS Workflows Software - BoostACart",
    description: "Find the ultimate sms cart recovery app tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/sms-cart-recovery-app",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "sms-cart-recovery-app",
  "metaTitle": "Best SMS Workflows Software - BoostACart",
  "metaDescription": "Find the ultimate sms cart recovery app tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "SMS Workflows",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your sms cart recovery app efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master sms cart recovery app, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine sms cart recovery app by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "SMS Workflows",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for sms cart recovery app?",
