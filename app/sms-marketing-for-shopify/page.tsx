...
export const metadata: Metadata = {
  title: "The Ultimate Guide to SMS Marketing - BoostACart",
  description: "Master sms marketing for shopify. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/sms-marketing-for-shopify"
  },
  openGraph: {
    title: "The Ultimate Guide to SMS Marketing - BoostACart",
    description: "Master sms marketing for shopify. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/sms-marketing-for-shopify",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "sms-marketing-for-shopify",
  "metaTitle": "The Ultimate Guide to SMS Marketing - BoostACart",
  "metaDescription": "Master sms marketing for shopify. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "SMS Marketing",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your sms marketing for shopify efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master sms marketing for shopify, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine sms marketing for shopify by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Text Messaging",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve sms marketing for shopify?",
