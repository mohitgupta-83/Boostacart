...
export const metadata: Metadata = {
  title: "The Ultimate Guide to Ecommerce CRO - BoostACart",
  description: "Master ecommerce conversion rate optimization. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/ecommerce-conversion-rate-optimization"
  },
  openGraph: {
    title: "The Ultimate Guide to Ecommerce CRO - BoostACart",
    description: "Master ecommerce conversion rate optimization. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/ecommerce-conversion-rate-optimization",
    type: "website"
  }
};
...
const pageData: SeoPageData = {
  ...
  "metaTitle": "The Ultimate Guide to Ecommerce CRO - BoostACart",
  "metaDescription": "Master ecommerce conversion rate optimization. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "Ecommerce CRO",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your ecommerce conversion rate optimization efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master ecommerce conversion rate optimization, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine ecommerce conversion rate optimization by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Store Conversions",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve ecommerce conversion rate optimization?",
