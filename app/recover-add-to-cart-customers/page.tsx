...
export const metadata: Metadata = {
  title: "Best Customer Recovery Software - BoostACart",
  description: "Find the ultimate recover add to cart customers tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/recover-add-to-cart-customers"
  },
  openGraph: {
    title: "Best Customer Recovery Software - BoostACart",
    description: "Find the ultimate recover add to cart customers tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/recover-add-to-cart-customers",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "recover-add-to-cart-customers",
  "metaTitle": "Best Customer Recovery Software - BoostACart",
  "metaDescription": "Find the ultimate recover add to cart customers tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Customer Recovery",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your recover add to cart customers efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master recover add to cart customers, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine recover add to cart customers by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Customer Recovery",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for recover add to cart customers?",
