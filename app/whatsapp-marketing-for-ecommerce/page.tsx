...
export const metadata: Metadata = {
  title: "The Ultimate Guide to WhatsApp Marketing - BoostACart",
  description: "Master whatsapp marketing for ecommerce. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/whatsapp-marketing-for-ecommerce"
  },
  openGraph: {
    title: "The Ultimate Guide to WhatsApp Marketing - BoostACart",
    description: "Master whatsapp marketing for ecommerce. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/whatsapp-marketing-for-ecommerce",
    type: "website"
  }
};
...
const pageData: SeoPageData = {
  ...
  "metaTitle": "The Ultimate Guide to WhatsApp Marketing - BoostACart",
  "metaDescription": "Master whatsapp marketing for ecommerce. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "WhatsApp Marketing",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your whatsapp marketing for ecommerce efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master whatsapp marketing for ecommerce, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine whatsapp marketing for ecommerce by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Chat Conversions",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve whatsapp marketing for ecommerce?",
