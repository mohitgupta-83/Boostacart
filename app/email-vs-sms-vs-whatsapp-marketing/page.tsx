...
export const metadata: Metadata = {
  title: "The Ultimate Guide to Omnichannel Marketing - BoostACart",
  description: "Master email vs sms vs whatsapp marketing. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/email-vs-sms-vs-whatsapp-marketing"
  },
  openGraph: {
    title: "The Ultimate Guide to Omnichannel Marketing - BoostACart",
    description: "Master email vs sms vs whatsapp marketing. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/email-vs-sms-vs-whatsapp-marketing",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "email-vs-sms-vs-whatsapp-marketing",
  "metaTitle": "The Ultimate Guide to Omnichannel Marketing - BoostACart",
  "metaDescription": "Master email vs sms vs whatsapp marketing. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "Omnichannel Marketing",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your email vs sms vs whatsapp marketing efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master email vs sms vs whatsapp marketing, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine email vs sms vs whatsapp marketing by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Multi-Channel",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve email vs sms vs whatsapp marketing?",
