...
export const metadata: Metadata = {
  title: "Case Study: How AuraJewelry achieved a 90% Open Rate with BoostACart",
  description: "Read the in-depth case study on how AuraJewelry deployed pre-checkout cart recovery to achieve a 90% Open Rate scaling their D2C brand on Shopify.",
  alternates: {
    canonical: "https://boostacart.com/whatsapp-cart-recovery-case-study"
  },
  openGraph: {
    title: "Case Study: How AuraJewelry achieved a 90% Open Rate with BoostACart",
    description: "Read the in-depth case study on how AuraJewelry deployed pre-checkout cart recovery to achieve a 90% Open Rate scaling their D2C brand on Shopify.",
    url: "https://boostacart.com/whatsapp-cart-recovery-case-study",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "whatsapp-cart-recovery-case-study",
  "metaTitle": "Case Study: How AuraJewelry achieved a 90% Open Rate with BoostACart",
  "metaDescription": "Read the in-depth case study on how AuraJewelry deployed pre-checkout cart recovery to achieve a 90% Open Rate scaling their D2C brand on Shopify.",
  "heroBadge": "Verified Case Study",
  "heroTitleLight": "How AuraJewelry Achieved",
  "heroTitleHighlight": "a 90% Open Rate",
  "heroSubtitle": "An inside look at the exact timing, sequences, and scripts AuraJewelry used to recover massive amounts of abandoned revenue using BoostACart.",
  "problemBadge": "The Challenge",
  "problemTitle": "AuraJewelry Was Losing Traffic At",
  "problemHighlight": "The Cart Page",
  "problemText1": "Before using BoostACart, AuraJewelry was spending thousands on Meta and TikTok ads, driving heavy traffic that would click Add-to-Cart but bounce before typing their email at checkout.",
  ...
  "solutionText": "AuraJewelry installed our async snippet in exactly 2 minutes. They enabled the WhatsApp fallback mechanism and offered a 10% discount to users who unlocked their cart.",
  ...
  "featuresSubtitle": "Here are the tools in our platform that allowed AuraJewelry to completely transform their back-end economics.",
  "features": [
    {
      "icon": "cart",
  ...
  "faqs": [
    {
      "question": "Can my store replicate AuraJewelry's results?",
    ...
    {
      "question": "Did AuraJewelry need a developer for this?",
