...
export const metadata: Metadata = {
  title: "Best Automated Campaigns Software - BoostACart",
  description: "Find the ultimate email followup abandoned carts tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
...
const pageData: SeoPageData = {
  "slug": "email-followup-abandoned-carts",
  "metaTitle": "Best Automated Campaigns Software - BoostACart",
  "metaDescription": "Find the ultimate email followup abandoned carts tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Automated Campaigns",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your email followup abandoned carts efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master email followup abandoned carts, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine email followup abandoned carts by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Automated Campaigns",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for email followup abandoned carts?",
