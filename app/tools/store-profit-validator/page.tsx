            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 md:p-10 shadow-2xl">
                <div className="grid md:grid-cols-2 gap-10">
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-white/80 mb-1">Monthly Total Revenue</label>
                            <input type="number" value={revenue} onChange={(e) => setRevenue(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-blue-500 focus:outline-none" placeholder="10,00,000" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-white/80 mb-1">Product Cost (COGS) %</label>
                            <input type="number" value={cogsPct} onChange={(e) => setCogsPct(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-blue-500 focus:outline-none" placeholder="35" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-white/80 mb-1">Total Monthly Ad Spend</label>
                            <input type="number" value={adSpend} onChange={(e) => setAdSpend(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-blue-500 focus:outline-none" placeholder="2,00,000" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-white/80 mb-1">Fixed Costs (Staff, Software, etc.)</label>
                            <input type="number" value={fixedCosts} onChange={(e) => setFixedCosts(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-xl py-3 px-4 text-white focus:border-blue-500 focus:outline-none" placeholder="1,00,000" />
                        </div>
                    ...
                    <div className="bg-white/5 rounded-2xl p-6 border border-white/10 flex flex-col justify-center">
                        {!hasCalculated ? (
                            ...
                            <div className="space-y-6 text-center">
                                <div>
                                    <p className="text-sm text-white/60 mb-1">Total Monthly Net Profit</p>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                                        <p className="text-sm text-white/60 mb-1">Net Margin</p>
                                    ...
                                    <div className="bg-white/5 border border-white/10 rounded-xl p-4 flex flex-col justify-center">
                                        <p className="text-sm text-white/60 mb-1">COGS Impact</p>
                                        <p className="text-xl font-bold text-white/80">{formatCurr(parseFloat(revenue) * (parseFloat(cogsPct) / 100))}</p>
                                    </div>
                                </div>
