...
export const metadata: Metadata = {
  title: "Best Intent Capture Software - BoostACart",
  description: "Find the ultimate collect email at add to cart tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
...
const pageData: SeoPageData = {
  "slug": "collect-email-at-add-to-cart",
  "metaTitle": "Best Intent Capture Software - BoostACart",
  "metaDescription": "Find the ultimate collect email at add to cart tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Intent Capture",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your collect email at add to cart efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master collect email at add to cart, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine collect email at add to cart by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Intent Capture",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for collect email at add to cart?",
