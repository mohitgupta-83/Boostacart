...
export const metadata: Metadata = {
  title: "The Ultimate Guide to DTC Cart Recovery - BoostACart",
  description: "Master dtc cart recovery strategy. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/dtc-cart-recovery-strategy"
  },
  openGraph: {
    title: "The Ultimate Guide to DTC Cart Recovery - BoostACart",
    description: "Master dtc cart recovery strategy. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/dtc-cart-recovery-strategy",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "dtc-cart-recovery-strategy",
  "metaTitle": "The Ultimate Guide to DTC Cart Recovery - BoostACart",
  "metaDescription": "Master dtc cart recovery strategy. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "DTC Cart Recovery",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your dtc cart recovery strategy efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master dtc cart recovery strategy, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine dtc cart recovery strategy by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Scaling Brands",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve dtc cart recovery strategy?",
