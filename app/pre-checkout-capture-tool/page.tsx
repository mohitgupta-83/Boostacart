...
export const metadata: Metadata = {
  title: "Best Pre-Checkout Ops Software - BoostACart",
  description: "Find the ultimate pre checkout capture tool tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/pre-checkout-capture-tool"
  },
  openGraph: {
    title: "Best Pre-Checkout Ops Software - BoostACart",
    description: "Find the ultimate pre checkout capture tool tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/pre-checkout-capture-tool",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "pre-checkout-capture-tool",
  "metaTitle": "Best Pre-Checkout Ops Software - BoostACart",
  "metaDescription": "Find the ultimate pre checkout capture tool tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Pre-Checkout Ops",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your pre checkout capture tool efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master pre checkout capture tool, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine pre checkout capture tool by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Pre-Checkout Ops",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for pre checkout capture tool?",
