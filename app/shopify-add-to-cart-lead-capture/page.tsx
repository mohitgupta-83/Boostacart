...
export const metadata: Metadata = {
  title: "Best Shopify Leads Software - BoostACart",
  description: "Find the ultimate shopify add to cart lead capture tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/shopify-add-to-cart-lead-capture"
  },
  openGraph: {
    title: "Best Shopify Leads Software - BoostACart",
    description: "Find the ultimate shopify add to cart lead capture tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/shopify-add-to-cart-lead-capture",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "shopify-add-to-cart-lead-capture",
  "metaTitle": "Best Shopify Leads Software - BoostACart",
  "metaDescription": "Find the ultimate shopify add to cart lead capture tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Shopify Leads",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your shopify add to cart lead capture efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master shopify add to cart lead capture, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine shopify add to cart lead capture by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Shopify Leads",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for shopify add to cart lead capture?",
