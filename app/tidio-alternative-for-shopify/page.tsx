...
export const metadata: Metadata = {
  title: "Best Tidio Alternative for Shopify (2025) - BoostACart",
  description: "Looking for a Tidio alternative? See why modern Shopify brands are switching to BoostACart for higher-converting, intent-driven lead capture.",
  alternates: {
    canonical: "https://boostacart.com/tidio-alternative-for-shopify"
  },
  openGraph: {
    title: "Best Tidio Alternative for Shopify (2025) - BoostACart",
    description: "Looking for a Tidio alternative? See why modern Shopify brands are switching to BoostACart for higher-converting, intent-driven lead capture.",
    url: "https://boostacart.com/tidio-alternative-for-shopify",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "tidio-alternative-for-shopify",
  "metaTitle": "Best Tidio Alternative for Shopify (2025) - BoostACart",
  "metaDescription": "Looking for a Tidio alternative? See why modern Shopify brands are switching to BoostACart for higher-converting, intent-driven lead capture.",
  "heroBadge": "Tidio Alternative",
  "heroTitleLight": "The Superior Alternative To",
  "heroTitleHighlight": "Tidio",
  ...
  "problemTitle": "Tidio Waits Too Long",
  "problemHighlight": "To Save Carts",
  "problemText1": "Most Tidio users rely entirely on customers reaching the checkout page or triggering annoying popups. But generic popups annoy users, and waiting for checkout means you lose 80% of your traffic.",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart a great Tidio alternative?",
    ...
    {
      "question": "Is it hard to uninstall Tidio and install BoostACart?",
