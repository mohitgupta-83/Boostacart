...
export const metadata: Metadata = {
  ...
  description: "BoostACart is a cart recovery tool for Shopify that captures leads at add-to-cart and helps store owners recover lost sales through WhatsApp",
  alternates: {
