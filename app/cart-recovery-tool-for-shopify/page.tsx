...
export const metadata: Metadata = {
  title: "Best Shopify Cart Recovery Software - BoostACart",
  description: "Find the ultimate cart recovery tool for shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
    canonical: "https://boostacart.com/cart-recovery-tool-for-shopify"
  },
  openGraph: {
    title: "Best Shopify Cart Recovery Software - BoostACart",
    description: "Find the ultimate cart recovery tool for shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
    url: "https://boostacart.com/cart-recovery-tool-for-shopify",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "cart-recovery-tool-for-shopify",
  "metaTitle": "Best Shopify Cart Recovery Software - BoostACart",
  "metaDescription": "Find the ultimate cart recovery tool for shopify tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Shopify Cart Recovery",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your cart recovery tool for shopify efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master cart recovery tool for shopify, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine cart recovery tool for shopify by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Shopify Cart Recovery",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for cart recovery tool for shopify?",
