...
export const metadata: Metadata = {
  title: "Best Dropshippers Software - BoostACart",
  description: "Find the ultimate cart recovery for dropshipping tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  alternates: {
...
const pageData: SeoPageData = {
  "slug": "cart-recovery-for-dropshipping",
  "metaTitle": "Best Dropshippers Software - BoostACart",
  "metaDescription": "Find the ultimate cart recovery for dropshipping tool. Recover up to 10x more abandoned carts by capturing shoppers before they ever reach the checkout page.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Tool For",
  "heroTitleHighlight": "Dropshippers",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your cart recovery for dropshipping efforts.",
  "problemBadge": "The Real Problem",
  "problemTitle": "Traditional Methods Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master cart recovery for dropshipping, relying solely on standard Shopify checkout emails is setting yourself up for failure.",
  ...
  "solutionText": "We redefine cart recovery for dropshipping by bringing the data collection to the absolute peak of the customer journey.",
  ...
  "featuresHighlight": "Dropshippers",
  ...
  "faqs": [
    {
      "question": "Why is BoostACart the best choice for cart recovery for dropshipping?",
