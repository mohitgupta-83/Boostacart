...
export const metadata: Metadata = {
  title: "The Ultimate Guide to Lead Generation Strategies - BoostACart",
  description: "Master ecommerce lead generation strategies. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  alternates: {
    canonical: "https://boostacart.com/ecommerce-lead-generation-strategies"
  },
  openGraph: {
    title: "The Ultimate Guide to Lead Generation Strategies - BoostACart",
    description: "Master ecommerce lead generation strategies. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
    url: "https://boostacart.com/ecommerce-lead-generation-strategies",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "ecommerce-lead-generation-strategies",
  "metaTitle": "The Ultimate Guide to Lead Generation Strategies - BoostACart",
  "metaDescription": "Master ecommerce lead generation strategies. Learn how capturing leads at the Add-to-Cart stage drastically improves your conversions and recovery metrics.",
  "heroBadge": "Store Optimization",
  "heroTitleLight": "The Ultimate Playbook For",
  "heroTitleHighlight": "Lead Generation Strategies",
  "heroSubtitle": "Stop leaving money on the table. Discover how our unique pre-checkout flow supercharges your ecommerce lead generation strategies efforts and scales your profit margins.",
  "problemBadge": "The Funnel Leak",
  "problemTitle": "Traditional Interventions Are",
  "problemHighlight": "Broken",
  "problemText1": "If you are trying to master ecommerce lead generation strategies, relying solely on standard Shopify checkout emails or generic website popups is setting yourself up for failure.",
  ...
  "solutionText": "We redefine ecommerce lead generation strategies by bringing data collection to the absolute peak of the customer journey—the exact second they decide to add an item.",
  ...
  "featuresHighlight": "Scaling Leads",
  ...
  "faqs": [
    {
      "question": "How exactly does this approach improve ecommerce lead generation strategies?",
