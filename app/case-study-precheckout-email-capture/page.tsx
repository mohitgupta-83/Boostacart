...
export const metadata: Metadata = {
  title: "Case Study: How SkinGlow achieved Massive Scale with BoostACart",
  description: "Read the in-depth case study on how SkinGlow deployed pre-checkout cart recovery to achieve Massive Scale scaling their D2C brand on Shopify.",
  alternates: {
    canonical: "https://boostacart.com/case-study-precheckout-email-capture"
  },
  openGraph: {
    title: "Case Study: How SkinGlow achieved Massive Scale with BoostACart",
    description: "Read the in-depth case study on how SkinGlow deployed pre-checkout cart recovery to achieve Massive Scale scaling their D2C brand on Shopify.",
    url: "https://boostacart.com/case-study-precheckout-email-capture",
    type: "website"
  }
};

const pageData: SeoPageData = {
  "slug": "case-study-precheckout-email-capture",
  "metaTitle": "Case Study: How SkinGlow achieved Massive Scale with BoostACart",
  "metaDescription": "Read the in-depth case study on how SkinGlow deployed pre-checkout cart recovery to achieve Massive Scale scaling their D2C brand on Shopify.",
  "heroBadge": "Verified Case Study",
  "heroTitleLight": "How SkinGlow Achieved",
  "heroTitleHighlight": "Massive Scale",
  "heroSubtitle": "An inside look at the exact timing, sequences, and scripts SkinGlow used to recover massive amounts of abandoned revenue using BoostACart.",
  "problemBadge": "The Challenge",
  "problemTitle": "SkinGlow Was Losing Traffic At",
  "problemHighlight": "The Cart Page",
  "problemText1": "Before using BoostACart, SkinGlow was spending thousands on Meta and TikTok ads, driving heavy traffic that would click Add-to-Cart but bounce before typing their email at checkout.",
  ...
  "solutionText": "SkinGlow installed our async snippet in exactly 2 minutes. They enabled the WhatsApp fallback mechanism and offered a 10% discount to users who unlocked their cart.",
  ...
  "featuresSubtitle": "Here are the tools in our platform that allowed SkinGlow to completely transform their back-end economics.",
  "features": [
    {
      "icon": "cart",
  ...
  "faqs": [
    {
      "question": "Can my store replicate SkinGlow's results?",
    ...
    {
      "question": "Did SkinGlow need a developer for this?",
